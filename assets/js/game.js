...
//function to check if player would like to fight or skip
var fightOrSkip = function() {
   ...
   //return false if player doesn't answer
   return false;
}
...
var fight = function(enemy) {
    ...
    if (enemy.health <= 0) {
        ...
        //generate random values based on enemy's attack power
...
var shop = function() {
    ...
    var shopOptionPrompt = window.prompt(
        "Would you like to REFILL your health, UPGRADE your attack, or LEAVE the store? Please enter one choice: 1 for REFILL, 2 for UPGRADE, or 3 for LEAVE."
    );
